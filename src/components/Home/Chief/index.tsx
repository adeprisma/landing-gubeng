...
const Chief = () => {
    ...
    return (
        <section className='relative' id="chief-section">
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 my-16 space-x-5'>
                    ...
                    <div className='col-span-6 flex flex-col justify-center'>
                        ...
                        <h2 className="text-3xl lg:text-5xl font-semibold text-black dark:text-white text-start">
                            Kemuliaan Tuhan Yang Mengubah Hidup
                        </h2>
                        ...
                        <button className='text-xl font-medium rounded-full text-white py-5 px-6 bg-primary lg:px-10 mr-6 w-fit border border-primary hover:bg-transparent hover:text-primary'>Baca Lebih Lanjut</button>
                    </div>
                </div>
            </div>
        </section >
